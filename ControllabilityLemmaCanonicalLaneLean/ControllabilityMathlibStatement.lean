...
def mathlibProofObligation : MathlibProofObligation := {
  sourceKey := "controllability-lemma",
  theoremObject := "Controllability Lemma",
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedControllabilityClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_controllability_endgame A
